...
EMISSION_FACTORS = {
    "India" : {
        "Transportation" : 0.14, # kgC02/km
        "Electricity" : 0.82, #kgC02/KwH
...
st.set_page_config(layout="wide",page_title="Let's Calculate 🌱")

st.title("Carbon Calculator App🍃 (2024)")

# user inputs

st.subheader("Select Country")
country = st.selectbox("",["India"])
